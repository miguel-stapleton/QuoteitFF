...
export interface PriorityWarning {
  id: string;
  text: string;
  autoGenerated: boolean; // true if auto-generated from missing deposits, false if manually added
}
...
export interface CalculationResult {
  ...
  priorityWarnings: PriorityWarning[]; // Auto-generated + manually added warnings
}
